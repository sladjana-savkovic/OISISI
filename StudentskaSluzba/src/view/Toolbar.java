...
public class Toolbar extends JToolBar{
	...
	public Toolbar() {
		...
		setVisibleButtonAddStudent(false);
	...
	static public void setVisibleButtonAddStudent(boolean flag){
		buttonAddStudent.setVisible(flag);
	}
	static public void setVisibleButtonAddProfessor(boolean flag) {
		buttonAddProfessor.setVisible(flag);
	}
}
